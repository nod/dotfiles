...
hi Todo         guifg=#686460 guibg=#080404 gui=italic
hi Search       guifg=#000000 guibg=#f0f000 gui=italic
hi Visual                     guibg=#282020
hi MatchParen   guifg=#ffffff guibg=#904030 gui=none

hi Title        guifg=#ffffff guibg=#202020 gui=none
hi Underlined   guifg=#b4b0b0 guibg=#080404 gui=none
...
hi Statement    guifg=#506090 guibg=#080404 gui=none
hi Repeat       guifg=#906050 guibg=#080404 gui=none
hi Conditional  guifg=#609050 guibg=#080404 gui=none
hi Exception    guifg=#903020 guibg=#080404 gui=none
